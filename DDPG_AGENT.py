...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, buffer_size, batch_size, gamma, tau, lr_actor, lr_critic, weight_decay,noise_decay):
        ...
        self.noise_decay = noise_decay      # Add noise decay
